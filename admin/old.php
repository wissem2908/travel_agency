    ...
    <div class="admin-layout" id="adminLayout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item" data-page="adventures">
        ...
        <main class="main-content">
            ...
            <!-- Other sections (Customers, Analytics, Settings) would follow similar patterns -->
            <section class="page-section" id="customersPage">
                <div class="page-header">
                    <h1>Customers</h1>
                ...
                <div class="content-card">
                    <div class="card-body">
                        <p style="text-align: center; padding: 60px; color: var(--gray-medium); font-size: 18px;">
            ...
            <form id="adventureForm">
                <div class="form-row">
                    <div class="input-group">
                        ...
                        <input type="text" placeholder="e.g., Mountain Peak Expedition" required>
                    </div>
                    <div class="input-group">
                ...
                <div class="input-group">
                    ...
                    <textarea placeholder="Enter adventure description..." required></textarea>
                </div>
